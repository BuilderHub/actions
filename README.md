...
jobs:
  build:
    uses: builderhub/actions/.github/workflows/buildah-build-push-workflow.yaml@v0.1.0-beta.1
    with:
      image: myorg/myapp
...
jobs:
  build:
    uses: builderhub/actions/.github/workflows/docker-build-push-workflow.yaml@v0.1.0-beta.1
    with:
      image: myorg/myapp
      tags: latest ${{ github.sha }}
